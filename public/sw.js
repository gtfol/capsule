...
self.addEventListener("fetch", (event) => {
  ...
  if (event.request.method !== "GET" || url.origin !== self.location.origin || ["/privacy", "/terms"].includes(url.pathname) || url.pathname.startsWith("/api/") || url.pathname.startsWith("/share/") || url.pathname.startsWith("/scan/")) return;
