...
export function LegalPage({ title, children, effectiveDate = "September 18, 2026" }: { title: string; effectiveDate?: string; children: React.ReactNode }) {
  return <main className="mx-auto max-w-[680px] px-6 pb-16 pt-[30px] sm:px-[30px]">
    ...
    <header className="mb-10 mt-12">
      ...
      <p className="mt-3 text-[12px] text-muted-foreground">Effective {effectiveDate}</p>
    </header>
