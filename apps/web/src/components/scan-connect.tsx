...
export function ScanConnect({authorization,user,providers}:{authorization:{code_challenge:string;state:string;access?:"capture"|"wardrobe"};user:{id:string;name:string}|null;providers:{google:boolean;apple:boolean;email:boolean}}) {
