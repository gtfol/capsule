...
posthog = add('posthog-package', {'isa':'XCRemoteSwiftPackageReference','repositoryURL':'https://github.com/PostHog/posthog-ios.git','requirement':{'kind':'exactVersion','version':'3.81.0'}})
posthogProduct = add('posthog-product', {'isa':'XCSwiftPackageProductDependency','package':posthog,'productName':'PostHog'})
posthogBuild = add('posthog-build', {'isa':'PBXBuildFile','productRef':posthogProduct})
appFrameworks = add('app-frameworks', {'isa':'PBXFrameworksBuildPhase','buildActionMask':'2147483647','files':[posthogBuild],'runOnlyForDeploymentPostprocessing':'0'})
...
appSettings = {'PRODUCT_NAME':'$(TARGET_NAME)','PRODUCT_BUNDLE_IDENTIFIER':'dev.gtfol.capsule','TARGETED_DEVICE_FAMILY':'1','SUPPORTED_PLATFORMS':'iphoneos iphonesimulator','SUPPORTS_MACCATALYST':'NO','SUPPORTS_MAC_DESIGNED_FOR_IPHONE_IPAD':'NO','SUPPORTS_XR_DESIGNED_FOR_IPHONE_IPAD':'NO','CODE_SIGN_STYLE':'Automatic','INFOPLIST_FILE':'CapsuleScan/Info.plist','GENERATE_INFOPLIST_FILE':'NO','ASSETCATALOG_COMPILER_APPICON_NAME':'AppIcon','MARKETING_VERSION':'1.2','CURRENT_PROJECT_VERSION':'17','LD_RUNPATH_SEARCH_PATHS':['$(inherited)','@executable_path/Frameworks']}
testSettings = {'PRODUCT_NAME':'$(TARGET_NAME)','PRODUCT_BUNDLE_IDENTIFIER':'dev.gtfol.capsule.tests','TARGETED_DEVICE_FAMILY':'1','SUPPORTED_PLATFORMS':'iphoneos iphonesimulator','CODE_SIGN_STYLE':'Automatic','GENERATE_INFOPLIST_FILE':'YES','TEST_HOST':'$(BUILT_PRODUCTS_DIR)/CapsuleScan.app/$(BUNDLE_EXECUTABLE_FOLDER_PATH)/CapsuleScan','BUNDLE_LOADER':'$(TEST_HOST)','LD_RUNPATH_SEARCH_PATHS':['$(inherited)','@executable_path/Frameworks','@loader_path/Frameworks']}
...
appTarget = add('app-target',{'isa':'PBXNativeTarget','buildConfigurationList':appConfigs,'buildPhases':[appSources,appFrameworks,resources],'buildRules':[],'dependencies':[],'name':'CapsuleScan','productName':'CapsuleScan','packageProductDependencies':[posthogProduct],'productReference':app,'productType':'com.apple.product-type.application'})
