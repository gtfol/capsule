...
function ProductImages({ item }: { item: Item }) {
  ...
  const backSource = item.backImageUrl && item.backImageUrl !== item.imageUrl ? imageSource({ imageUrl: item.backImageUrl, imageData: item.backImageData }) : null;
