...
export function WardrobeApp() {
  ...
  return <Suspense fallback={<div className="min-h-dvh bg-background text-foreground"><main className="empty-state" role="status"><Loader2 size={16} className="animate-spin text-subtle" /><p className="mt-4 text-[12px] text-muted-foreground">Opening capsule…</p></main></div>}><WardrobeSurface key={space} /></Suspense>;
}
