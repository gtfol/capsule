...
export const metadata: Metadata = {
  title: "terms · capsule",
  description: "Terms for using capsule on the web and iPhone.",
  alternates: { canonical: "/terms" },
};

export default function TermsPage() {
  return <LegalPage title="terms of service">
    <p>These terms cover capsule on the web and iPhone, provided by gtfol, LLC. By using the services, you agree to these terms. Contact <a href="mailto:team@gtfol.dev">team@gtfol.dev</a> with questions.</p>
    <section><h2>using capsule</h2><p>capsule helps you record clothing, manage a wishlist, and render outfits. The capsule iPhone app photographs items for your capsule wardrobe. Keep your account and integration credentials secure. Use the services lawfully, without accessing another person’s data, bypassing security, or disrupting the service.</p></section>
    ...
    <section><h2>cost and support</h2><p>capsule currently has no subscription or paywall. Voluntary support payments are optional and do not unlock features. Contact us about payment problems. External API charges are separate and controlled by your provider account.</p></section>
