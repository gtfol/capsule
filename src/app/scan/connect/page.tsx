...
export const metadata: Metadata = {title:"sign in · capsule",robots:{index:false,follow:false}};
export default async function ScanConnectPage({searchParams}: {searchParams:Promise<Record<string,string|string[]|undefined>>}) {
  ...
  if (!params.success) return <main className="mx-auto max-w-sm px-6 py-20"><h1 className="text-lg">capsule</h1><p className="mt-6 text-sm text-muted-foreground">open the capsule app to sign in.</p></main>;
